            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h2 style="text-align:center; font-size:1.6em" class="panel-title">Login page for officials.</h2><br>
                        <p style="text-align:center">Please sign in with the username and password provided by the admin of this system.</p>
                    </div>
